...
global te ti he hi e0 r0 v0 nmass tstart sz tend d p te ti he hi smax signal_cut
...
% ?nderung am 23.04.13: Die Winkeldifferenz zwischen 157.5 und 0 is 22.5 
% (nicht 157.5 wie vorher)
    ...
    Wpp_distal = sel_mat*0.002.*exp(-0.23*diffAngleDistal); Wpp_distal(isnan(Wpp_distal)) = 0; 
